package com.techm.name.repository;

import com.techm.name.MainframeApplicationApp;
import com.techm.name.config.Constants;
import com.techm.name.config.audit.AuditEventConverter;
import com.techm.name.domain.PersistentAuditEvent;
...
import static com.techm.name.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
